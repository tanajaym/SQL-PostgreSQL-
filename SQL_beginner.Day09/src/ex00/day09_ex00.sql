...
CREATE OR REPLACE FUNCTION fnc_trg_person_insert_audit()--функция триггера бд
RETURNS TRIGGER as $person_audit$
BEGIN
IF (TG_OP = 'INSERT')--TG_OP это спеу переменная для определения типа входящих данных
